export class PatCalculator {
  ...
  calculate() {
    ...
    this.output.totalLicensedHours.textContent = formatHours(
      totalHours.licensed,
    );
    this.output.totalUnlicensedHours.textContent = formatHours(
      totalHours.unlicensed,
    );
    this.output.totalPhysicianHours.textContent = formatHours(
      totalHours.physician,
    );

    this.output.totalCost.textContent = formatMoney(
      totalHours.licensed * rates.licensed +
        totalHours.unlicensed * rates.unlicensed +
        totalHours.physician * rates.physician,
    );
  }
}
